...
<body>
    ...
    <div class="container">
        <a class="navbar-brand" target="_blank" href=".">Pokepedia</a>
        <button
    ...
    <div>
        <a href="https://www.instagram.com/nhanifna"
        ><i class="bi bi-instagram h2 p-2 text-dark"></i
        ></a>
        <a href="https://x.com/hanif_nauf23939"
        ><i class="bi bi-twitter-x h2 p-2 text-dark"></i
        ></a>
        <a href="https://wa.me/+6285210742500"
        ><i class="bi bi-whatsapp h2 p-2 text-dark"></i
        ></a>
    </div>
    <div> Naufal Hanif Noorvetriya Achmadi &copy; 2024</div>
    </footer>
    <!-- footer end -->
    <script
